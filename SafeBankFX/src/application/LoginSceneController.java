...
public class LoginSceneController {
	...
	public void handleLoginAction(ActionEvent event) throws IOException {
		...
		alertData.put("title", "Login");
		alertData.put("headerText", "You are about to login");
		alertData.put("contentText", "Do you want to continue ?");
		boolean okResponse = AlertController.showConfirmation(event, alertData);
		if(okResponse) {
